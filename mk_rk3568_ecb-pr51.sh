...
# 20201212 add - ECB-PR51 specific balance_irq (use generic rk3568)
...
# 20220927 add
BOARD_HOME="${PWD}/files/rk3568/ecb-pr51/board.d"
# 20221001 add
MODULES_HOME="${PWD}/files/rk3568/modules.d"
# 20221123 add
BOARD_MODULES_HOME="${PWD}/files/rk3568/ecb-pr51/modules.d"
# 20221013 add - WiFi config for AP6256
WIRELESS_CONFIG="${PWD}/files/rk3568/ecb-pr51/wireless"
# 20230622 add
NETWORK_SERVICE_PATCH="${PWD}/files/rk3568/r66s/network.patch"
